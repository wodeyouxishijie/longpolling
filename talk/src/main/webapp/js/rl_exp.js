	...
	*/
	var rl_exp = {
		...
		text:[			/*表情包title文字，自己补充*/
			[
				'a-bb','a-gl','a-hs','a-gx','a-ht','a-zb','a-fn','a-bn','a-ax','a-kl','a-hq','a-dx','a-gy','a-hf','a-lh','a-j','a-kbk','a-mm','a-ka','a-m',
				'a-lz'
			],
			[
				'b-tx','b-fn','b-cn','b-jj','b-zh','b-ch','b-bs','b-sx','b-zd','b-dj','b-kq','b-sk','b-kx','b-ts','b-gl','b-lg','b-skz','b-pz','b-gd','b-nb',
				'b-pz'
			]
		],
		num:		[21,21],
		...
		bind:	function(i){
			$("#rl_bq .rl_exp_main").eq(i).find('.rl_exp_item').each(function(){
				$(this).bind('click',function(){
					rl_exp.insertText(document.getElementById('inputTextId'),'['+$(this).find('img').attr('title')+']');
		...
		init:function(){
			...
			$("#rl_exp_btn").bind('click',function(){
				...
				var w = $(this).position();
				$('#rl_bq').css({right:0,bottom:0}).fadeIn(400);
			});
			/*绑定关闭按钮*/
